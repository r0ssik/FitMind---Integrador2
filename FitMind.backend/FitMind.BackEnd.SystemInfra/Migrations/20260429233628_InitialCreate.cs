        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CommonPortions = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MuscleMassPercentage = table.Column<decimal>(type: "numeric(4,1)", precision: 4, scale: 1, nullable: true),
                    Arm = table.Column<decimal>(type: "numeric(4,1)", precision: 4, scale: 1, nullable: true),
                    ...
                    Thigh = table.Column<decimal>(type: "numeric(4,1)", precision: 4, scale: 1, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Goal = table.Column<decimal>(type: "numeric(8,2)", precision: 8, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodDiaryEntries_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    NotifWorkout = table.Column<bool>(type: "boolean", nullable: false),
                    NotifDiet = table.Column<bool>(type: "boolean", nullable: false),
                    NotifWater = table.Column<bool>(type: "boolean", nullable: false),
                    NotifChallenge = table.Column<bool>(type: "boolean", nullable: false),
                    NotifSocial = table.Column<bool>(type: "boolean", nullable: false),
                    NotifAchievement = table.Column<bool>(type: "boolean", nullable: false),
                    PublicProfile = table.Column<bool>(type: "boolean", nullable: false),
                    ShowActivity = table.Column<bool>(type: "boolean", nullable: false),
                    ShowWeight = table.Column<bool>(type: "boolean", nullable: false),
                    Theme = table.Column<string>(type: "text", nullable: false),
                    Language = table.Column<string>(type: "text", nullable: false),
                    CalorieGoal = table.Column<int>(type: "integer", nullable: false),
                    WaterGoalCups = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    CurrentProgress = table.Column<decimal>(type: "numeric(8,2)", precision: 8, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "text", nullable: true),
                    WorkoutDayName = table.Column<string>(type: "text", nullable: true),
                    WorkoutFocus = table.Column<string>(type: "text", nullable: true),
                    ExercisesTotal = table.Column<int>(type: "integer", nullable: false),
                    SetsTotal = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodDiaryEntries_UserId",
